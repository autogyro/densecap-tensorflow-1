...
def parse_args():
    ...
    parser.add_argument('--ckpt', dest='out/ckpt',
                        help='initialize with pretrained model weights',
                        default=None, type=str)
    parser.add_argument('--cfg', dest='scripts/dense_cap_config.yml',
    ...
    parser.add_argument('--vocab', dest='output/ckpt/vocabulary.txt',
